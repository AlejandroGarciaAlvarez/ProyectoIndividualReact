...
🗺️ Vistas Principales (src/pages/)ArchivoFunciónLogin.jsxGestiona el formulario de entrada, validaciones y guarda el estado del usuario.Dashboard.jsxZona Privada.
